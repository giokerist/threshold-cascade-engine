...
and supply the output directory via <code>--scenario-dir</code>.</p>"""
    ...
    html += """<p>The following prioritisation ranks nodes by a composite score that
...
def build_markdown_report(
    ...
    lines.append("# Infrastructure Risk Audit Report\n")
...
""")
    ...
    rule()
    lines.append(
        "*Generated by report_gen.py — Cascade Propagation Engine Consultancy Wrapper.  \n"
        "Confidential — complement model results with domain-expert review.*\n"
    )
