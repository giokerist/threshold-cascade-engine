...
def run_k_sweep():
    ...
    for k in K_VALUES:
        ...
        try:
            ...
            cmd = [sys.executable, "-m", "cascade_engine.runner", temp_config_path, "--output-dir", output_dir]
            ...
            try:
                with open(summary_path, 'r') as f:
                    ...
                    results.append((k, rho, rmse_val))
                    print(f"{k:<10} | {rho:<15.4f} | {rmse_val:<10.4f}")
    ...
    if results:
        ...
        print("Plot saved to k_sweep_results.png")


if __name__ == "__main__":
    run_k_sweep()import json
import subprocess
import os
import tempfile
import matplotlib
